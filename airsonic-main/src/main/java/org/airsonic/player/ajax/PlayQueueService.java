...
import org.airsonic.player.service.playqueue.PlayStrategyContext;
...
public class PlayQueueService {
    ...
    @Autowired
    private PlayStrategyContext playStrategyContext; // nova injeção
    ...
    public PlayQueueInfo playPlaylist(int id, Integer startIndex) throws Exception {
        ...
        // Delega para a strategy "playlistPlayStrategy"
        List<MediaFile> files = playStrategyContext.getTracks("playlistPlayStrategy", String.valueOf(id));
    ...
    public PlayQueueInfo playTopSong(int id, Integer startIndex) throws Exception {
        ...
        // Delega para a strategy "topSongPlayStrategy"
        List<MediaFile> files = playStrategyContext.getTracks("topSongPlayStrategy", String.valueOf(id));
    ...
    private PlayQueueInfo convert(HttpServletRequest request, Player player, boolean serverSidePlaylist, int offset) {
        ...
        return new PlayQueueInfo.Builder()
                .entries(entries)
                .stopEnabled(isStopEnabled)
                .repeatEnabled(playQueue.isRepeatEnabled())
                .shuffleRadioEnabled(playQueue.isShuffleRadioEnabled())
                .internetRadioEnabled(playQueue.isInternetRadioEnabled())
